...
Appears under "Features" header, class `foo` subheader:

```
feat(foo): add 'tag' method
```

Appears under "Bug Fixes" header, class `foo` subheader, with a link to issue #28:

```
fix(foo): handle events correctly
